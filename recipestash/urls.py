...
urlpatterns = [
    ...
    url(r'^recipes/$', RedirectView.as_view(pattern_name='browse', permanent=True)),
    ...
    url(r'^accounts/create_recipe/$', views.create_recipe,
        name='registration_create_recipe'),
    ...
    url(r'^accounts/password/change_done/$',
        password_change_done,
        {'template_name':
